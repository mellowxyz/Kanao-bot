...
module.exports = {
 ...
 execute: async (message, args, client, prefix) => {
        ...
        try {
            ...
            if (code.includes(`SECRET`) || code.includes(`TOKEN`) || code.includes("process.env") || code.includes(`token`) || code.includes(`client.token`) ) {
                message.reply("<a:kanao_no2:981066235150225418>");
            } else {
